...
/// </remarks>
public class GUIChat : Photon.MonoBehaviour, IChatClientListener
{
    ...
    private static GUIChat instance;
    public static GUIChat Instance
    {
        get
        {
            if (instance == null)
            {
                instance = FindObjectOfType<GUIChat>();
            }
            return instance;
        }
    }
    ...
    public void Awake()
    {
        ...
        {
            Debug.LogWarning("Destroying duplicate instance of " + this.gameObject + ". GUIChat applies DontDestroyOnLoad() to this GameObject.");
    ...
    public void OnGUI()
    {
        ...
        else
        {
            ...
            if (channels.Count > 0)
            {
                ...
                GUILayout.Label(GUIChat.WelcomeText);
    ...
    private void PostHelpToCurrentChannel()
    {
        ...
        {
            channelForHelp.Add("info", GUIChat.HelpText);
        }
        else
        {
